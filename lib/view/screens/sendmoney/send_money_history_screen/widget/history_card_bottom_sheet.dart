          ...
          Row(
            ...
            children: [
              ...
              CardColumn(
                ...
                body: "${controller.currencySym}${Converter.formatNumber(controller.sendmoneyHistorydata[index].beforeCharge ?? "")}",
              )
            ],
          ),
          ...
          Row(
            ...
            children: [
              CardColumn(
                ...
                body: "${controller.currencySym}${Converter.formatNumber(controller.sendmoneyHistorydata[index].charge ?? "")} ",
              ),
              CardColumn(
                header: MyStrings.finalAmount.tr,
                body: "${controller.currencySym}${Converter.formatNumber(controller.sendmoneyHistorydata[index].amount ?? "")}",
                alignmentEnd: true,
              ),
            ],
          ),
          ...
          Row(
            ...
            children: [
              CardColumn(
                ...
                body: "${controller.currencySym}${Converter.formatNumber(controller.sendmoneyHistorydata[index].postBalance ?? "")}",
              ),
              CardColumn(
                alignmentEnd: true,
                header: MyStrings.details.tr,
                body: "${controller.sendmoneyHistorydata[index].details} ${controller.sendmoneyHistorydata[index].trxType == "+" ? controller.sendmoneyHistorydata[index].relatedTransaction?.user?.username : controller.sendmoneyHistorydata[index].receiverUser?.username}",
              ),
            ],
          )
        ],
