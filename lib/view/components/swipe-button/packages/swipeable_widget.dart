...
class SwipeableWidget extends StatefulWidget {
  ...
  const SwipeableWidget({super.key, required this.child, required this.height, required this.onSwipeCallback, required this.onSwipeValueCallback, required this.isActive, this.swipePercentageNeeded = 0.75})
